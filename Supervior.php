        ...
        <div class="head-title">
            <div class="left">
                ...
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a class="active" href="#">First Supervisor Performance</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <ul class="box-info">
            ...
            <li>
                ...
                <span class="text">
						...
						<h3>25.80%</h3>
						<p>2.4 Million of 9.3 Million </p>
					</span>
            </li>
        </ul>
        ...
        <div class="head-title">
            <div class="left">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><i class='bx bx-chevron-right' ></i></li>
                    <li>
                        <a class="active" href="#">Second Supervisor Performance</a>
                    </li>
                </ul>
            </div>
        </div>
