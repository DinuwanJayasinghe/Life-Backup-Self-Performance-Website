...
<head>
    ...
    <title>Team Leader Performance</title>
...
<section id="content">
    ...
    <main>
        <div class="head-title">
            <div class="left">
                ...
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a class="active" href="#">First Team Leader Performance</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <ul class="box-info">
            ...
            <li>
                <i class='bx bxs-badge-dollar' id="thrd_icon"></i>
                <span class="text">
                        <h4>Total Premium Collection</h4>
						<h3>50%</h3>
						<p>LKR 250,000.00 of LKR 500,000.00</p>
					</span>
            </li>
        </ul>
        ...
        <div class="head-title">
            <div class="left">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><i class='bx bx-chevron-right' ></i></li>
                    <li>
                        <a class="active" href="#">Second Team Leader Performance</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <ul class="box-info">
            ...
            <li>
                ...
                <span class="text">
                        <h4>Total Premium Collection</h4>
						<h3>40%</h3>
						<p>LKR 200,000.00 of LKR 500,000.00</p>
					</span>
            </li>
        </ul>
        ...
        <div class="head-title">
            <div class="left">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><i class='bx bx-chevron-right' ></i></li>
                    <li>
                        <a class="active" href="#">Third Team Leader Performance</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <ul class="box-info">
            ...
            <li>
                ...
                <span class="text">
                        <h4>Total Premium Collection</h4>
						<h3>90%</h3>
						<p>LKR 450,000.00 of LKR 500,000.00</p>
					</span>
            </li>
        </ul>
        ...
        <div class="head-title">
            <div class="left">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><i class='bx bx-chevron-right' ></i></li>
                    <li>
                        <a class="active" href="#">Fourth Team Leader Performance</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <ul class="box-info">
            ...
            <li>
                ...
                <span class="text">
                        <h4>Total Premium Collection</h4>
						<h3>30%</h3>
						<p>LKR 150,000.00 of LKR 500,000.00</p>
					</span>
            </li>
        </ul>
