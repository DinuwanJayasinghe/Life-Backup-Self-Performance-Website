...
if(isset($_POST['create_account'])){
    ...
    $password = $_POST['password'];
        ...
        if ($result) {
            ...
            header('location: Manager_Create Account.php'); // Dorection  Pathe.
...
<head>
    ...
    <title>Create Account | Manger</title>
    ...
    <main>
        ...
        <div class="page-content">
            ...
            <div class="form-v10-content">
                ...
                <form class="form-detail" action="#" method="post" id="myform" name="Create_Acc" autocomplete="off">
                    ...
                    <div class="form-right"><!--right-side-->
                        ...
                        <div class="form-row-last">
                            <input type="submit" name="create_account" class="register" value="Create Account" id="Create_Account">
                        </div>
                    </div>
                </form>
            </div>
...
function checkPassword()) {
    ...
    let oon_password = document.getElementById('Con_password').value;

    console.log(password, oon_password);
