...
<head>
    ...
    <title>Life Insurance Agent Performance</title>
...
<section id="content">
    ...
    <main>
        <div class="head-title">
            <div class="left">
                <h1>Life Insurance Agent Performance</h1>
                <ul class="breadcrumb">
                    <li>
                        <a href="#">Dashboard</a>
                    </li>
                    ...
                    <li>
                        <a class="active" href="#">First Life Insurance Agent Performance</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <ul class="box-info">
            ...
            <li>
                ...
                <span class="text">
						...
						<h3>86.66%</h3>
						<p>2LKR 650,000.00 of LKR 750,000.00  </p>
					</span>
            </li>
        </ul>
        ...
        <div class="head-title">
            <div class="left">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><i class='bx bx-chevron-right' ></i></li>
                    <li>
                        <a class="active" href="#">Second Life Insurance Agent Performance</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <ul class="box-info">
            ...
            <li>
                ...
                <span class="text">
                        <h4>Total Premium Collection</h4>
						<h3>53.33%</h3>
						<p>LKR 400,000.00 of LKR 750,000.00 </p>
					</span>
            </li>
        </ul>
        ...
        <div class="head-title">
            <div class="left">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><i class='bx bx-chevron-right' ></i></li>
                    <li>
                        <a class="active" href="#">Third Life Insurance Agent Performance</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <ul class="box-info">
            ...
            <li>
                ...
                <span class="text">
                        <h4>Total Premium Collection</h4>
						<h3>46.66%</h3>
						<p>LKR 350,000.00 of LKR 750,000.00 </p>
					</span>
            </li>
        </ul>
